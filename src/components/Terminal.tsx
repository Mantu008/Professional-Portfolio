  ...
  switch (cmd.toLowerCase()) {
    ...
    case "projects":
      newCommand.response = (
        <ul className="list-disc list-inside">
          <li>
            <span className="text-blue-400">PRINTsnap (UI)</span> — Campus-Focused Printing Solution
          </li>
          <li>
            <span className="text-blue-400">LinkNest</span> — Advanced URL Shortener
          </li>
          <li>
            <span className="text-blue-400">RateShield</span> — API Rate Limiting Library
          </li>
        </ul>
      );
      break;
    ...
    case "contact":
      newCommand.response = (
        <div>
          <p>Email: <a href="mailto:ankitsharma7805@gmail.com">ankitsharma7805@gmail.com</a></p>
          <p>GitHub: <a href="https://github.com/ankitsharma38/">https://github.com/ankitsharma38/</a></p>
          <p>LinkedIn: <a href="https://www.linkedin.com/in/ankit-sharma-08b37a26a/">https://www.linkedin.com/in/ankit-sharma-08b37a26a/</a></p>
        </div>
      );
      break;
    case "socials":
