...
export function TechToolkit() {
  ...
  const visibleCategories = isMobile ? (showMore ? categories : categories.slice(0, 2)) : categories;

  return (
    <section id="tech-stack" className="py-20 px-4 bg-gray-900 relative overflow-hidden">
