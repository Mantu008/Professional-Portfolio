  ...
  const certifications = [
    {
      ...
      date: "2025",
      type: "Winner",
      description: "Secured Rank 1 in Half Hackathon 2025.",
      skills: ["Team Leadership", "Project Management", "Security", "Scalability"],
      validity: "Lifetime",
      credentialId: "N/A",
      status: "Active",
      icon: <Cloud className="w-6 h-6" />,
      certificateImage: "/images/Gallery/Certificates/RITA_certification.jpg"
    },
    {
      title: "Certification of Winner",
      organization: "S.F.S EDU EXPO",
      date: "2025",
      type: "Winner",
      description: "A certification for event participation and contribution",
      skills: ["MERN Stack", "AI/ML", "Scalability"],
      validity: "Lifetime",
      credentialId: "N/A",
      status: "Active",
      icon: <Monitor className="w-6 h-6" />,
      certificateImage: "/images/Gallery/Certificates/sfsEduCertification.jpg"
    },
    {
      title: "Cyber Quest Hackathon",
      organization: "Cyber Peace And Indian Army",
      date: "2024",
      type: "Finalist",
      description: "Finalist in Cyber Quest Hackathon. Developed a DeepFake Detection tool using AI/ML and secured an internship opportunity.",
      skills: ["AI/ML", "DeepFake Detection", "Cybersecurity", "Team Collaboration"],
      validity: "Lifetime",
      credentialId: "N/A",
      status: "Active",
      icon: <Award className="w-6 h-6" />,
      certificateImage: "/images/Gallery/Certificates/Cyber Quest 2024.jpg"
    },
  ];
  ...
  return (
    <section className="py-24 px-4 bg-gray-900 relative overflow-hidden">
      ...
      {showCertificate && (
        ...
        >
          <div className="relative max-w-2xl w-full bg-gray-800 rounded-2xl shadow-xl" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setShowCertificate(false)}
